...
public class TabbedItem extends JToggleButton {
    ...
    public formularioPropiedades getComponent() {
        return component;
    }
    ...
    private final formularioPropiedades component;
    private final String tabbedName;

    public TabbedItem(String name, formularioPropiedades component) {
    ...
    private void init(String name) {
        ...
        putClientProperty(FlatClientProperties.STYLE, ""
                ...
                + "arc:10;"
                + "margin:2,8,2,5");
        JButton cmd = new JButton(new FlatSVGIcon("Media/close.svg", 0.6f));
        cmd.addActionListener((ae) -> {
            TabBarra.getInstance().removeTab(this);
        });
