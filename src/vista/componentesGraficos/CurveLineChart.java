...
public class CurveLineChart extends JComponent {
   ...
   private CurviLinearChart curviLinearChart;

    public CurveLineChart(CurviLinearChart curviLinearChart) {
        this.curviLinearChart = curviLinearChart; // Inyectar la instancia de CurviLinearChart
    }
